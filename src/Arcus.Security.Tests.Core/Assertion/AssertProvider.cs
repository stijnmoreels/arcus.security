...
namespace Arcus.Security.Tests.Core.Assertion
{
    ...
    {
        public static async Task ContainsSecretAsync(ISecretProvider provider, string secretName, string secretValue, string secretVersion, Action<SecretOptions> configureOptions = null)
        {
...
#pragma warning disable S6966 // We should also test the synchronous version of the method.
            ...
            Secret syncSecret = AssertResult.Success(provider.GetSecret(secretName, options));
...
#pragma warning restore S6966
            ...
            Secret asyncSecret = AssertResult.Success(await provider.GetSecretAsync(secretName, options));
