...
<div className="row">
  <div className="col col--6">
    <Card shadow='tl'>
      ...
      <CardBody>
        Vulnerabilities are introduced when secrets are seen as data (logs or when expired secrets don't get transient handling upon retrieval).
...
<details>
<summary><h3 style={{ margin:0 }}>🔄 Secret mapping</h3></summary>
...
<details>
<summary><h3 style={{ margin:0 }}>🏷️ Naming secret providers</h3></summary>
